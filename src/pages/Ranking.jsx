...
import { getRankingLocalStorage, getTokenLocalStorage } from '../server';
  ...
  render() {
    ...
    return (
      getTokenLocalStorage() ? (
        <div className=" bg-ultra-purple pt-4 min-h-screen">
          <h1
              ...
              { JSON.parse(getRankingLocalStorage()).sort((a, b) => {
                ...
                >
                  ...
                  <div className="flex justify-between items-center w-4/5">
                    ...
                    {key === 0
                      && <li><img src={ goldMedal } alt="" className="w-8" /></li>}
